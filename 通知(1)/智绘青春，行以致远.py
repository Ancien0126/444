...
url = "https://www.cs.sdu.edu.cn/info/1055/6310.htm"
...
# 找到所有属性为"style"，其对应属性值为"font-family: 宋体, SimSun;"的标签
content_paragraphs = soup.find_all(attrs={"style": "font-family: 宋体, SimSun;"})
